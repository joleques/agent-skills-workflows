...
Colete no contexto local da execucao:
1. **Diretorio raiz do projeto** analisado
...
Pergunte ao usuario apenas se alguma dessas informacoes for realmente indisponivel e bloquear a revisao.
